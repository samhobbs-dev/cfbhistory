...
import com.cfbh.cfbhbackend.repository.FullTeamRepository;
...
public class TeamService {
    ...
    @Autowired
    private FullTeamRepository fullTeamRepository;
    @Autowired
    ...
    public List<FullTeam> getAllTeamsInYear(int year) throws Exception {
        ...
        //     fullTeams.add(new FullTeam(t,t.getLogo(),t.getCurrentLogo()));
        // }        
        List<FullTeam> fullTeams = fullTeamRepository.findAllInYear(year);
        return fullTeams;
    }
}
